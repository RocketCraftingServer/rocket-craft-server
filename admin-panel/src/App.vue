<template>
  <div id="app">
    ...
    <div ref="mybodycontent" v-bind:style="styleObject">
      ...
      <emailService
        v-show="visibility.emailServiceComponent"
        :slogan="this.$store.state.system.getEmailAddress()">
      </emailService>

      <rocketAccounts
        v-show="visibility.account"
      ...
      <users
        v-show="visibility.usersComponent"
        prefix="rocket"
        :domain="$props.AppDomainHost">
      </users>

      <userRocketProfile
        v-show="visibility.userProfileComponent"
        prefix="rocket"
        :domain="$props.AppDomainHost">
      </userRocketProfile>
      ...
      <leaderboard
        v-show="visibility.leadrboardComponent"
        prefix="rocket"
        :domain="$props.AppDomainHost">
      </leaderboard>
      <!--country-selector>
    ...
    <myFooter
      textContent="http://maximumroulette.com Rocket-Craft-Server Integrity 2022"
    ></myFooter>
  </div>
</template>
...
export default class App extends AppProps {
  ...
  public setGenericComponentVisibility() {
    this.$data.visibility.genericComponent = !this.$data.visibility
      .genericComponent;
  }

  public setEmailServiceVisibility() {
    this.$data.visibility.emailServiceComponent = !this.$data.visibility
      .emailServiceComponent;
  }

  public setUsersVisibility() {
    this.$data.visibility.usersComponent = !this.$data.visibility
      .usersComponent;
  }
