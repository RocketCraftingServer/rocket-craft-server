...
<template>
  <div v-bind:style="styleObject" class="md-primary myshadows" >
    ...
    <md-dialog :md-active.sync="showDialog">
      ...
      <md-tabs md-dynamic-height>
        <md-tab md-label="Privacy Policy">
          <md-content class="md-scrollbar">
            ...
            <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://maximumroulette.com</p>
            ...
            <p>Use of Data</p>
            <p>Software development Nikola Lukic uses the collected data for various purposes:</p>
            ...
            <p>Software development Nikola Lukic will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
          </md-content>
        </md-tab>
        ...
        <md-tab md-label="Disclosure Of Data">
          <md-content class="md-scrollbar">
            <h3>Legal Requirements</h3>

            <p>Software development Nikola Lukic may disclose your Personal Data in the good faith belief that such action is necessary to:</p>

            <p>To comply with a legal obligation</p>
            <p>To protect and defend the rights or property of Software development Nikola Lukic</p>
      ...
      <md-dialog-actions>
        <md-button class="md-primary" @click="showDialog = false">NOT ACCEPT</md-button>
        <md-button class="md-primary md-positive" @click="showDialog = false">ACCEPT</md-button>
      </md-dialog-actions>
    </md-dialog>
